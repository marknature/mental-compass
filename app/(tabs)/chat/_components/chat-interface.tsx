...
export function ChatInterface() {
  ...
  return (
    <div className="flex flex-col flex-1 w-full overflow-y-auto py-2 space-y-4 pt-6">
      {/* Messages area */}
      ...
      {suggestions.length > 0 && (
        <div className="px-4 py-2 flex gap-2 overflow-x-hidden">
      ...
      <div className="border-t fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[390px] z-40 bg-background">
        ...
        <div className="px-4 pb-4 pt-0">
          <p className="text-[10px] text-center text-muted-foreground">
            ...
            or call a crisis helpline. Contacts found in the{" "}
            <Link href={"/resources"} className="underline text-primary">
              resources page
            </Link>
          </p>
        </div>
